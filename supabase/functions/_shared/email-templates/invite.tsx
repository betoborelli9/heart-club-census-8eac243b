      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={paragraph}>
            Alguém te convidou para fazer parte do Heart Club — o maior censo de torcidas do mundo.
          </Text>
          <Text style={paragraph}>
            Clique no botão abaixo para aceitar o convite e representar seu clube:
          </Text>
