...
BEGIN
  ...
  SELECT
    ...
    f.cidade::text,
    f.estado::text,
    -- DECISÃO MANUAL DO ADMIN TEM PRIORIDADE ABSOLUTA
    CASE
      WHEN f.stored_status = 'aprovado' AND NOT f.stored_suspicious THEN false
    ...
    CASE
      ...
      WHEN f.stored_status = 'aprovado' AND NOT f.stored_suspicious THEN 'aprovado'
    ...
    CASE
      ...
      WHEN f.stored_status = 'aprovado' AND NOT f.stored_suspicious THEN NULL
