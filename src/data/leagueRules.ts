...
const serieB: LeagueRules = {
  ...
  rulesTitle: "Regras de Acesso — Brasileirão Série B 2026",
  sections: [
    { title: "1. Acesso Direto (2 vagas)",
      body: "38 rodadas em pontos corridos com turno e returno. Apenas Campeão e Vice sobem automaticamente à Série A de 2027." },
    { title: "2. Play-off de Acesso (2 vagas)",
      body: "As outras duas vagas para a elite são decididas em mata-mata pós-fase corrida entre 3º e 6º colocados, em jogos de ida e volta:",
      bullets: [
        "Semifinais: 3º × 6º e 4º × 5º",
        "Vantagem: 3º e 4º decidem em casa (melhor campanha)",
        "Vencedores dos dois confrontos sobem — não há final entre eles",
      ] },
    { title: "3. Rebaixamento",
