...
const Index = () => {
  ...
  // Redireciona se já estiver logado e já tiver votado (opcional)
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-[#020202] text-white p-4 flex flex-col items-center justify-center py-10 selection:bg-red-600">
      <div className="max-w-md w-full space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
        ...
        <div className="space-y-4 bg-zinc-900/20 p-6 rounded-3xl border border-white/5">
          ...
          {!heartTeam ? (
            ...
            <div className="bg-white p-4 rounded-2xl flex items-center justify-between shadow-[0_10px_30px_rgba(255,255,255,0.05)] border-2 border-red-600 animate-in zoom-in-95 duration-300">
