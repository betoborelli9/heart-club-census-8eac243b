  ...
  return (
    <div className="min-h-screen bg-[#020202] text-white p-4 flex flex-col items-center justify-center py-10 selection:bg-red-600">
      <div className="max-w-md w-full space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700 relative z-10">
        ...
        {/* SEÇÃO: CLUBE DO CORAÇÃO - Z-INDEX CORRIGIDO */}
        <div className="space-y-4 bg-zinc-900/20 p-6 rounded-3xl border border-white/5 relative z-">
          ...
          {!heartTeam ? (
            <div className="relative z- pointer-events-auto">
            ...
            <div className="bg-white p-4 rounded-2xl flex items-center justify-between shadow-[0_10px_30px_rgba(255,255,255,0.05)] border-2 border-red-600 animate-in zoom-in-95 duration-300 relative z-">
              ...
              <button 
                ...
                className="bg-zinc-100 hover:bg-red-100 text-zinc-400 hover:text-red-600 p-2 rounded-full transition-colors pointer-events-auto"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
        ...
        {/* SEÇÃO: SIMPATIA - Z-INDEX CORRIGIDO PARA NÃO TRAVAR */}
        <div className="space-y-4 bg-zinc-900/20 p-6 rounded-3xl border border-white/5 relative z-">
          ...
          <div className="grid grid-cols-1 gap-2 mt-4 relative z-">
            {sympathyTeams.map(club => (
              <div key={club.nome} className="bg-zinc-900/60 border border-white/5 p-3 rounded-xl flex items-center justify-between group">
                ...
                <button 
                  ...
                  className="text-zinc-600 group-hover:text-red-500 transition-colors pointer-events-auto"
                >
                  <X className="w-4 h-4" />
                </button>
              </div>
        ...
        {/* BOTÃO FINAL - Z-INDEX MÁXIMO E SEM TRAVA */}
        <div className="pt-4 relative z-">
          <Button 
            onClick={handleConfirmVote}
            disabled={issubmitting || !heartTeam}
            className="w-full bg-red-600 hover:bg-red-700 text-white font-black uppercase italic py-8 rounded-2xl shadow-[0_15px_40px_rgba(226,26,33,0.3)] transition-all hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 disabled:grayscale relative z- pointer-events-auto"
          >
