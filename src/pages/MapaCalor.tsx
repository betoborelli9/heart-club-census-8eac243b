...
O mapa de calor está aceitável, e por favor, não estrague nada.



avalie o código e corrija o que for necessário, sem estragar nada que esteja funcionando. coloque no padrão que eu gosto com separação por modulo de funções e rodapé no final
...
amigo... o mapa de calor ficou às escuras.



não aparece nada. aff
