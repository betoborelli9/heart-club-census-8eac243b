...
import { FlaskConical, Vote, Map as MapIcon, Users, BarChart3, UserCog, ShieldCheck, X, ChevronUp } from "lucide-react";
import { useUser } from "@/contexts/UserContext";
import { isMasterEmail } from "@/lib/master";

const ITEMS = [
  { label: "Corrigir votos de torcedores", icon: ShieldCheck, to: "/master/votos" },
